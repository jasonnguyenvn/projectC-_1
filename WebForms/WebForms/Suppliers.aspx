<%@ Page Language="C#"  MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="Suppliers.aspx.cs" Inherits="WebForms.Suppliers" %>
     ...
     <asp:Label ID="scriptLb" runat="server"></asp:Label>
      ...
      <div class="box box-primary" style="height:auto;">
        <div class="box-header with-border">
          <h3 class="box-title">Suppliers Manager</h3>
        ...
        <div class="box-body no-padding" style="height:auto;">
            ...
            <div id="content" class="row">
                ...
                <div class="col-md-7" style="height:auto;" >
                    ...
                    <div id="dataTable">
                        <asp:GridView ID="gvSuppliers" runat="server" AutoGenerateSelectButton="True" 

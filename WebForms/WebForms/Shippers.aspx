<%@ Page Language="C#"  MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="Shippers.aspx.cs" Inherits="WebForms.Shippers" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Shippers Manager</title>
</asp:Content>
     ...
     <asp:Label ID="scriptLb" runat="server"></asp:Label>
      ...
      <div class="box box-primary" style="height:auto;">
        <div class="box-header with-border">
          <h3 class="box-title">Shippers Manager</h3>
        ...
        <div class="box-body no-padding" style="height:auto;">
            ...
            <div id="content" class="row">
                ...
                <div class="col-md-7" style="height:auto;" >
                    ...
                    <div id="dataTable">
                        <asp:GridView ID="gvShippers" runat="server" AutoGenerateSelectButton="True" 
                            CellPadding="0" CellSpacing="6" EnableTheming="True" ForeColor="#333333" 
                            GridLines="None" HorizontalAlign="Left" AllowPaging="True" 
                            EnableModelValidation="True" 
                            onpageindexchanging="gvShippers_PageIndexChanging" 
                            onselectedindexchanged="gvShippers_SelectedIndexChanged" 

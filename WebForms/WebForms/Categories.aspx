<%@ Page Language="C#"  MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="WebForms.Categories" %>
...
<asp:Content ID="content_header" ContentPlaceHolderID="content_header" runat=server>
    <section class="content-header">
      <h1>
        Production
        <small>Categories Manager</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="box-body no-padding" style="height:auto;">
            ...
            <div id="content" class="row">
                ...
                <div class="col-md-7" style="height:auto;" >
                    ...
                    <div id="dataTable">
                        <asp:GridView ID="gvCategories" runat="server" AutoGenerateSelectButton="True" 

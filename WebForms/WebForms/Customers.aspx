<%@ Page Language="C#"  MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="WebForms.Customers" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Cusomter Manager</title>
</asp:Content>
     ...
     <asp:Label ID="scriptLb" runat="server"></asp:Label>
      ...
      <div class="box box-primary" style="height:auto;">
        <div class="box-header with-border">
          <h3 class="box-title">Cusomter Manager</h3>
        ...
        <div class="box-body no-padding" style="height:auto;">
            ...
            <div id="content" class="row">
                ...
                <div class="col-md-5">
                    <div id="filter">
                        ...
                        <div class="a_row">
                            ...
                            <div class="row_right">
                                <asp:TextBox ID="txtContName" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                        </div>
                        <div class="a_row">
                            <div class="row_left">
                ...
                <div class="col-md-7" style="height:auto;" >
                    ...
                    <div id="dataTable">
                        <asp:GridView ID="gvCustomers" runat="server" AutoGenerateSelectButton="True" 
